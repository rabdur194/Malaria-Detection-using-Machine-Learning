...
* **Source:** [NIH / Kaggle Malaria Cell Images Dataset](https://www.kaggle.com/datasets/iarunava/cell-images-for-detecting-malaria?utm_source=gemini)

* **Total Samples:** 27,558 single-cell microscopic images

* **Classes:** Balanced distribution between `Parasitized` ($13,779$) and `Uninfected` ($13,779$)

* **Preprocessing:** Resizing ($128 \times 128$ px), intensity normalization, and real-time data augmentation (rotations, flips, zoom) to prevent overfitting.
...
Evaluation on an unseen test set ($20\%$ holdout) yielded the following comparative results across models:
